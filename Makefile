...
ifneq ($(COMPILER_LAUNCHER),)
    CMAKE_C_COMPILER_ARGS += -D'CMAKE_C_COMPILER_LAUNCHER'='${COMPILER_LAUNCHER}'
    CMAKE_CXX_COMPILER_ARGS += -D'CMAKE_CXX_COMPILER_LAUNCHER'='${COMPILER_LAUNCHER}'
else
    CMAKE_C_COMPILER_ARGS += -D'CMAKE_C_COMPILER_LAUNCHER'=''
    CMAKE_CXX_COMPILER_ARGS += -D'CMAKE_CXX_COMPILER_LAUNCHER'=''
endif
...
DEPS_PREFIX := default-${SYSTEM_TARGET_SLUG}-${EXE_TARGET_SLUG}-${COMPILER_SLUG}-deps
